    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "collection_name": {
                    "type": "string",
                    "description": "Optional Milvus collection override",
                },
                "drop_old": {
                    "type": "boolean",
                    "description": "Drop old collection on action=index",
                    "default": False,
                },
                "search_type": {
                    "type": "string",
                    "description": "Retriever search strategy",
                    "enum": ["mmr", "similarity", "similarity_score_threshold"],
                    "default": "mmr",
                },
                "top_k": {
                    "type": "integer",
                ...
                "return_source_documents": {
                    "type": "boolean",
                    "description": "Include source chunks in action=query response",
                    "default": True,
                },
                "scope": {
                    "type": "string",
                    "description": "Sharing scope: team (shared) or private (user-only)",
                    "enum": ["team", "private"],
                    "default": "team",
                },
                "org_id": {
                ...
                "team_id": {
                    "type": "string",
                    "description": "Tenant team id",
                },
                "user_id": {
                    "type": "integer",
                    "description": "Current user id for private scope",
                },
                "milvus_host": {
                    "type": "string",
