...
class Settings(BaseSettings):
    ...
    RAG_EMBEDDING_COOLDOWN_SECONDS: float = 15.0
    RAG_QUERY_EMBED_CACHE_TTL_SECONDS: int = 180
    RAG_QUERY_EMBED_CACHE_MAX_ITEMS: int = 256
    RAG_DOC_CHUNK_SIZE: int = 1800
    RAG_DOC_CHUNK_OVERLAP: int = 300
    RAG_DOC_LARGE_TEXT_THRESHOLD_CHARS: int = 700000
    RAG_DOC_LARGE_CHUNK_SIZE: int = 6000
